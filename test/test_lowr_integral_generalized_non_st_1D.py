...
class Test_M(unittest.TestCase):
    ...
    def setUp(self):
         ...
         lrgp = LowRankGeneralizedNonStationary(beta0 = None, variance= variance, space = Space([-1,1]), n_serie =  10, n_dimension = 1, random_state = rng)
    ...
    def test_cos_Block(self):
       ...
       print("cos_block[%i,%i]" % (9,9))
       tmp = get_numerical_integral_HH(lrgp, 9,9) 
       print(M[9,9])
       print(tmp)
       self.assertAlmostEqual(M[9,9], tmp, places=7)
       print("")
